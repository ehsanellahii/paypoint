    ...
    <Wrapper style='py-10'>
      <section className='w-full h-full grid md:grid-cols-2 gap-4 md:gap-2 '>
        <article className='w-full h-full flex flex-col items-start gap-3 md:max-w-[80%] mx-auto'>
          <h5 className='text-blue-royal text-xl font-bold'>{t('Features')}</h5>
          ...
          <ul className='w-full h-full flex flex-col gap-3'>
            {StaticData.Landing.FeaturesWithOrder.map((itm, idx) => (
              <li
                ...
                <div className='w-[1.7rem] h-[1.7rem] rounded-full text-white-main bg-blue-royal p-1 flex items-center justify-center'>
          ...
          <Button
            className='bg-blue-royal px-8 py-6 rounded-md font-semibold text-white-main border-none mt-4 text-lg md:text-xl'
            type='button'>
            {t('Demo anfordern')}
          </Button>
        </article>
