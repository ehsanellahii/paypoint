...
const Heading: React.FC<{ text: string; style?: string }> = ({
  ...
  return <h1 className={`text-2xl font-bold ${style}`}>{t(text)}</h1>;
};
      ...
      <div className='w-full grid md:grid-cols-2 gap-8 lg:gap-[7rem] mt-8'>
        <article className='w-full h-full flex flex-col items-start'>
          ...
          <Paragraph
            content={[
              {
                text: 'Das Kassensystem von PayPoint ist schnell und einfach zu bedienen und bietet dir zugleich die Möglichkeit, über die Lieferportalanbindung an zahlreiche Lieferportale angeschlossen zu sein Aber du bist damit auch für deinen eigenen Lieferdienst mit unserer',
              },
        ...
        <article>
          <Heading
            style='pb-3'
            text='PayPoint Kassensystem mit Lieferportalanbindung zu allen Anbietern'
          />
          <Paragraph
            content={[
              { text: 'Unsere' },
              ...
              {
                text: 'Lieferportal-Anbieter, wie Lieferando, DiscoEat, Wolt, Uber Eats oder Google Food Ordering',
                bold: true,
              },
              {
          ...
          <ul className='pl-4'>
            <li className='font-bold list-disc'>
              {t(
                'Alle Bestellungen von Lieferportalen direkt im System durch die POS Integration'
              )}
            </li>
            <li className='font-bold list-disc'>
              {t('Bon wird direkt ausgedruckt – kein Abtippen von Bons in die Kasse')}
            </li>
            <li className='font-bold list-disc'>
              {t('Automatisierung von Bestelleingängen')}
            </li>
            <li className='font-bold list-disc'>
              {t(
          ...
          <Paragraph
            content={[
              {
                text: 'Die Integration erfolgt nahtlos, sodass bestehende Accounts weiterverwendet werden können Auch für die Buchhaltung verläuft der Datenaustausch durch unsere Integrationen automatisch und ohne Umwege',
              },
            ]}
          />
          <Paragraph
            content={[
              {
                text: 'So gibt es beispielsweise eine',
              },
              {
                text: 'DATEV Schnittstelle',
                bold: true,
              },
              {
                text: 'und Integration für die Gastronomie Arbeite mit den Anbindungen zu diversen Schnittstellen noch effizienter und steigere deine Umsätze!',
              },
            ]}
          />
        </article>
...
export default DeliveryPortalDetails;
