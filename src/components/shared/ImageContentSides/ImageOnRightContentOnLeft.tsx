...
const ImageOnRightContentOnLeft = ({
  ImageUrl,
  Header,
  TitleOne,
  TitleTwo,
  ...
  return (
    <article className='w-full h-full grid md:grid-cols-2 gap-4 place-items-center'>
      <div className='flex flex-col gap-4 py-8 md:py-8  order-2 md:order-1 md:pl-16'>
        ...
        <ul className='space-y-3'>
          {Bullets.map((itm, idx) => (
            <li key={idx} className='w-full h-full flex items-center gap-2 text-lg'>
      ...
      <div className='w-full h-full px-2 py-4 order-1 md:order-2 '>
...
export default ImageOnRightContentOnLeft;
